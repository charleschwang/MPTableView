...
@property (nonatomic, getter=isSelected) BOOL selected; // set selected state. default is NO. animated is NO. you can override -setSelected: to turn animated to YES in subclass ([super setSelected:selected animated:YES]).
